...
function Editor(props) {
  ...
  const basicInfoBody = (
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Name"
          placeholder="Enter your full name eg. Shahbaz"
          value={values.name}
          onChange={(event) =>
  ...
  const handleSubmission = () => {
     // Check if any value in the values object is empty
  ...
  const handlePreviousPage = () => {
    ...
    setactiveSectionKey(sectionKeys[previousIndex]);
  };

  // Function to handle updating values
